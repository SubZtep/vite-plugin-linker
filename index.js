...
__export(exports, {
  default: () => watcherPlugin
});
var import_promises = __toModule(require("fs/promises"));
var import_child_process = __toModule(require("child_process"));
var import_fs_extra = __toModule(require_lib());
async function watcherPlugin(options) {
  const watcher = (0, import_promises.watch)(options.watch);
  let lock = false;
  for await (const {eventType} of watcher) {
    ...
    setTimeout(() => {
      ...
      (0, import_child_process.exec)(options.exec, async () => {
        console.log("Copying");
        try {
          await (0, import_fs_extra.copy)(options.dist, options.target, {overwrite: true});
        } catch (err) {
